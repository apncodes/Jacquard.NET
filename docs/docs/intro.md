...
- **NativeAOT-ready** — designed for AOT-published deployment. Measured ~96ms average cold-start init duration on Graviton2 Lambda (arm64, 512 MB, 5 cold starts). See the [AotLambda sample](https://github.com/apncodes/StrandsAgents.net/tree/main/samples/AotLambda).
