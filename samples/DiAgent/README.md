...
A two-turn console assistant wired entirely through `Microsoft.Extensions.DependencyInjection`. Shows how to register models, tools, sessions, and the agent itself using the `Jacquard.Extensions.DI` extension methods, and how to configure context-window trimming through `AgentConfig`.
