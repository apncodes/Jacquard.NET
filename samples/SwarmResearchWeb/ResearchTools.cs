    ...
    private static readonly IReadOnlyDictionary<string, TopicData> _topics =
        new Dictionary<string, TopicData>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["artificial intelligence"] = new(
                Facts: """
                    - AI encompasses machine learning, deep learning, NLP, computer vision, and robotics
                    - Global AI market projected to reach $1.8 trillion by 2030 (Grand View Research)
                    - Transformer architecture (2017) underpins most modern AI breakthroughs
                    - AI is being deployed in healthcare, finance, manufacturing, and autonomous vehicles
                    - Regulatory frameworks are emerging: EU AI Act, US Executive Order on AI (2023)
                    """,
                Sources: "Stanford HAI AI Index 2024, McKinsey Global Institute, OECD AI Policy Observatory",
                Critique: """
                    - Market projections vary wildly — cite ranges and methodology, not single figures
                    - The article should address job displacement concerns alongside productivity gains
                    - Distinguish narrow AI (current) from AGI (speculative) — conflation misleads readers
                    - Include perspectives from both AI optimists and critics for balance
                    """),
        };

    private const string NotFound =
        "No data found for this topic. " +
        "Covered topics: 'quantum computing', 'large language models', 'renewable energy', 'artificial intelligence'.";
