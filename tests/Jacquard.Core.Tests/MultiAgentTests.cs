...
public class MultiAgentTests
{
    ...
    public async Task AgentTool_InvokeAsync_CallsAgentWithPrompt()
    {
        ...
        var tool = new Jacquard.MultiAgent.AgentTool(agent.Object, "sub_agent", "A helpful sub-agent.");
    ...
    public async Task AgentTool_MissingPrompt_ReturnsFailure()
    {
        ...
        var tool = new Jacquard.MultiAgent.AgentTool(agent.Object, "sub_agent", "desc");
    ...
    {
        var tool = new Jacquard.MultiAgent.AgentTool(AgentReturning("x").Object, "my_tool", "Does things");
