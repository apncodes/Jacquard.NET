...
// Aliases to avoid ambiguity between Jacquard.Core and Amazon.BedrockRuntime types
using CoreGuardrailAction = Jacquard.Core.GuardrailAction;
using CoreGuardrailSource = Jacquard.Core.GuardrailSource;
using CoreStopReason = Jacquard.Core.StopReason;
using CoreModelRequest = Jacquard.Core.ModelRequest;
using CoreModelParameters = Jacquard.Core.ModelParameters;
using CoreMessage = Jacquard.Core.Message;
using CoreHookRegistry = Jacquard.Core.HookRegistry;
using CoreGuardrailViolationEvent = Jacquard.Core.GuardrailViolationEvent;
