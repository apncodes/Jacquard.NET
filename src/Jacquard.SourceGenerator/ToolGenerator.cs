...
namespace Jacquard.SourceGenerator;
...
public sealed class ToolGenerator : IIncrementalGenerator
{
    ...
    private static readonly DiagnosticDescriptor NonPartialClassDiagnostic = new(
        ...
        category: "Jacquard.SourceGenerator",
        ...
        var parameters = method.Parameters
            ...
            .Select(p =>
            {
                var validationAttr = p.GetAttributes()
                    .FirstOrDefault(a => a.AttributeClass?.ToDisplayString() == "Jacquard.Core.ToolParameterValidationAttribute");
        ...
        List<ToolMethodInfo> methods)
    {
        ...
        sb.AppendLine("using Jacquard.Core;");
        sb.AppendLine();
